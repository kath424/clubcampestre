...
<div class="inner-container">
    ...
    <section id="<?php echo $key.'_content'; ?>" class="<?php echo $masonry_section_class; ?>">
        ...
        <div class="<?php echo $masonry_row_class; ?> row">
            <?php if (!have_posts()) : ?>
                <div class="alert">
                    <?php _e('Sorry, no results were found.', 'ENTREPRENEUR'); ?>
                </div>
                <?php get_search_form(); ?>
            <?php endif; ?>
        ...
        <div class="row">
            <?php if ($wp_query->max_num_pages > 1) : ?>
                <nav class="post-nav">
                    <ul class="pager">
                            <li class="previous"><?php next_posts_link(__('&larr; Older posts', 'ENTREPRENEUR')); ?></li>
                            <li class="next"><?php previous_posts_link(__('Newer posts &rarr;', 'ENTREPRENEUR')); ?></li>
                    </ul>
                </nav>
            <?php endif; ?>
        </div>
