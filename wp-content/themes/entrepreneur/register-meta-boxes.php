...
function _themo_general_meta_boxes($meta_boxes) {
    ...
    //-----------------------------------------------------
        $themo_blog_category_meta_box = array(
            ...
            'title'       => __( 'Category Filter', 'ENTREPRENEUR' ),
            'pages'       => array( 'page' ),
            'context'     => 'normal',
            'priority'    => 'default',
            'fields'      => array(
    ...
    $themo_meta_box_builder_meta = array(
        ...
        'fields'      => array(
            array(
                ...
                'name'       =>  'Meta Boxes',
                'type'        => 'checkbox_list',
                'desc' => "<p>Need help? <a href='http://docs.themovation.com/entrepreneur/#metaboxbuilder' target='_blank'>Meta Box Documentation</a></p>",
                'options' => array(
                    'accordion' =>  __('Accordion', 'ENTREPRENEUR'),
                    'booked_calendar' =>  __('Booked Calendar', 'ENTREPRENEUR'),
                    'brands' =>  __('Brands',  'ENTREPRENEUR'),
                    'call_to_action' =>  __('Call to Action', 'ENTREPRENEUR'),
                    'content_editor' =>  __('Content Editor', 'ENTREPRENEUR'),
                    'conversion_form' =>  __('Conversion Form', 'ENTREPRENEUR'),
                    'faq' =>  __('FAQ', 'ENTREPRENEUR'),
                    'featured' =>  __('Featured', 'ENTREPRENEUR'),
                    'map' =>  __('Map', 'ENTREPRENEUR'),
                    'slider_master' => __('Master Slider', 'ENTREPRENEUR'),
                    'portfolio' =>  __('Portfolio', 'ENTREPRENEUR'),
                    'pricing_plans' =>  __('Pricing Plans', 'ENTREPRENEUR'),
                    'service_block' =>  __('Service Block', 'ENTREPRENEUR'),
                    'service_block_split' =>  __('Service Block Split', 'ENTREPRENEUR'),
                    'showcase' =>  __('Showcase', 'ENTREPRENEUR'),
                    'slider' =>  __('Slider', 'ENTREPRENEUR'),
                    'team' =>  __('Team', 'ENTREPRENEUR'),
                    'testimonials' =>  __('Testimonials', 'ENTREPRENEUR'),
                    'thumb_slider' =>  __('Thumbnail Slider', 'ENTREPRENEUR'),
                    'tour' =>  __('Tour', 'ENTREPRENEUR'),
                    'html' =>  __('WYSIWYG / Rich Text Editor', 'ENTREPRENEUR'),
                ),
