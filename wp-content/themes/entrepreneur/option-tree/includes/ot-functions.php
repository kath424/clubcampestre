    ...
    if ( function_exists('icl_t') ) {
      ...
      if ( isset( $settings['settings'] ) ) {
        ...
        foreach( $settings['settings'] as $setting ) {
          ...
          // List Item & Slider
          if ( isset($setting['id']) && $option_id == $setting['id'] && in_array( $setting['type'], array( 'list-item', 'slider' ) ) ) {
          ...
          // List Item & Slider
          } else if ( isset($setting['id']) && $option_id == $setting['id'] && $setting['type'] == 'social-links' ) {
          ...
          } else if ( isset($setting['id']) && $option_id == $setting['id'] && in_array( $setting['type'], apply_filters( 'ot_wpml_option_types', array( 'text', 'textarea', 'textarea-simple' ) ) ) ) {
