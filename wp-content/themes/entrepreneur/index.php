...
<div class="inner-container">
    ...
    <div class="row">
    	<div class="col-md-12">
			<?php if (!have_posts()) : ?>
            	<div class="error-404">
                    <p><?php esc_html_e('Sorry, the page you are looking for has not been found.', 'ENTREPRENEUR'); ?></p>
                    <br />
                    <?php get_search_form(); ?>
            	</div>
        	<?php endif; ?>
            ...
            <nav class="post-nav">
                <ul class="pager">
                    <li class="previous"><?php next_posts_link(esc_html__('&larr; Older posts', 'ENTREPRENEUR')); ?></li>
                    <li class="next"><?php previous_posts_link(esc_html__('Newer posts &rarr;', 'ENTREPRENEUR')); ?></li>
                </ul>
            </nav>
            <?php endif; ?>
