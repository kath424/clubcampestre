										...
										<div id="booked-subtab-email-settings" class="subtab-content">
											...
											<div class="section-row">
												<div class="section-head">
													...
													<?php $section_title = esc_html__('Having Email Issues?', 'booked'); ?>
													<h3><?php echo esc_attr($section_title); ?></h3>
				
													<p><strong style="display:block; margin:0 0 5px; font-size:14px;"><?php esc_html_e('No emails sending at all:','booked'); ?></strong>
													<?php echo sprintf( esc_html__('If no emails are being sent at all, trying using an SMTP plugin: %s','booked'), '<a href="https://wordpress.org/plugins/wp-mail-smtp/" target="_blank">https://wordpress.org/plugins/wp-mail-smtp/</a>' ); ?></p>

													<p><strong style="display:block; margin:0 0 5px; font-size:14px;"><?php esc_html_e('Emails not sending to admins/agents:','booked'); ?></strong>
													<?php esc_html_e('Some SMTP clients reject emails being sent "from" your customers. Google is one of them, but they simply change the name of the sender to prevent the rejection. Others do not. You can check the following option to "Force the sender name/email", but you will not be able to reply directly to the notification emails coming from customers.','booked'); ?></p>
													...
													<p style="margin:1em 0 0;"><strong style="display:block; margin:0 0 5px; font-size:14px;"><?php esc_html_e("So what's the best option?", "booked"); ?></strong>
													<?php echo sprintf( esc_html__('Using a reliable SMTP server is the best option. We recommend %s (no affiliation), which will allow up to 10,000 emails per month and then they charge a small fee beyond that. This does not replace your email account, you are just using it to reliably send emails from your website.','booked'), '<a href="https://www.mailgun.com/" target="_blank">MailGun</a>' ); ?></p>
...
Your friends at '.get_bloginfo('name');
													...
													<ul class="cp-list">
														<li><strong>%name%</strong> &mdash; <?php esc_html_e("To display the person's name.","booked"); ?></li>
														<li><strong>%email%</strong> &mdash; <?php esc_html_e("To display the person's email address.","booked"); ?></li>
														<li><strong>%username%</strong> &mdash; <?php esc_html_e("To display the username for login.","booked"); ?></li>
								...
								<div id="booked-defaults" class="tab-content">
									...
									<div id="timepickerTemplate" class="bookedClearFix">
										<div class="timeslotTabs bookedClearFix">
											<a class="addTimeslotTab active" href="#Single"><?php esc_html_e('Add Single','booked'); ?></a>
											<a class="addTimeslotTab" href="#Bulk"><?php esc_html_e('Add Bulk','booked'); ?></a>
										</div>
										...
										<span class="cancel button"><?php esc_html_e('Cancel','booked'); ?></span>
									</div>
