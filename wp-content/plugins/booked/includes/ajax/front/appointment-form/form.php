...
<div class="condition-block customer_choice default" id="condition-new">
	<form action="" method="post" id="newAppointmentForm">
		...
		<div class="field">
			...
			<?php else: ?>
				<input type="submit" id="submit-request-appointment" class="button button-primary" value="<?php echo _n( 'Request Appointment', 'Request Appointments', $total_appts, 'booked' ); ?>">
				<button class="cancel button"><?php esc_html_e('Cancel','booked'); ?></button>
			<?php endif; ?>
		</div>
	</form>
