...
function booked_add_to_calendar_button($dates,$cf_meta_value){
	if (!get_option('booked_hide_google_link',false)):
		...
		?><span class="addtocalendar atc-style-booked google-cal-button">
			<a class="atcb-link"><?php esc_html_e('Add to Calendar','booked'); ?></a>
	        <var class="atc_event">
	            ...
	            <var class="atc_title"><?php echo sprintf(esc_html__('Appointment with %s','booked'),get_bloginfo('name')); ?></var>
