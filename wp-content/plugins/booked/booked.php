...
/*
Plugin Name: Booked Classic - Appointment Booking
...
define('BOOKED_VERSION', '1.9.15');
define('BOOKED_FA_VERSION','4.7.0');
		...
		**********************/
		...
		public function admin_scripts() {
			...
			if (in_array($current_page,$this->booked_screens) || $screen->id == 'dashboard'):
				...
				wp_enqueue_script('booked-font-awesome', 'https://use.fontawesome.com/efd4223bc5.js', array(), BOOKED_FA_VERSION);
				...
				$booked_js_vars = array(
					...
					'i18n_add' => esc_html__('Add','booked'),
		...
		public static function front_end_styles() {
			...
			if ( defined('NECTAR_THEME_NAME') && NECTAR_THEME_NAME == 'salient' ):
				wp_enqueue_style('booked-salient-overrides', BOOKED_PLUGIN_URL . '/css/theme-specific/salient.css', array(), BOOKED_VERSION);
			endif;
