...
( function( $ ){            
	...
	// check all checkboxes
        $('.wpbm_selectable_body').find('.check-column').find(':checkbox').click( function(e) {
	//$('.wpbm_selectable_body').children().children('.check-column').find(':checkbox').click( function(e) {
