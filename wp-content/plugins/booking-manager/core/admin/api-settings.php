...
//debuge($this->fields);die;                
    ...
    public function enqueue_js( $menu_slug, $active_page_tab, $active_page_subtab ) {
        ...
        $js_script .= " jQuery('#wpbm_show_advanced_section_link_show').on( 'click', function(){                                 
                            jQuery('#wpbm_show_advanced_section_link_show').slideToggle(200);                            
                            jQuery('#wpbm_show_advanced_section_link_hide').animate( {opacity: 1}, 200 ).slideToggle(200);     
        ...
        $js_script .= " jQuery('#wpbm_show_advanced_section_link_hide').on( 'click', function(){    
                            jQuery('#wpbm_show_advanced_section_link_hide').slideToggle(200);                            
                            jQuery('#wpbm_show_advanced_section_link_show').animate( {opacity: 1}, 200 ).slideToggle(200);                        
        ...
        $js_script .= " jQuery('#wpbm_powered_by_link_show').on( 'click', function(){                                 
                            jQuery('#wpbm_powered_by_link_show').slideToggle(200);                            
                            jQuery('#wpbm_powered_by_link_hide').animate( {opacity: 1}, 200 ).slideToggle(200);  
        ...
        $js_script .= " jQuery('#wpbm_powered_by_link_hide').on( 'click', function(){    
                            jQuery('#wpbm_powered_by_link_hide').slideToggle(200);                            
                            jQuery('#wpbm_powered_by_link_show').animate( {opacity: 1}, 200 ).slideToggle(200);   
