...
class WPBM_Notices {
	...
	public function show_system_notices( $page_arr ) {
		...
		if (	    wpbm_is_updated_paid_to_free()
			...
			printf( __( 'Probabaly you updated your paid version of Booking Manager by free version or update process failed. You can request the new update of your paid version at %1sthis page%2s.', 'booking-manager' )
					, '<a href="http://oplugins.com/plugins/wp-booking-manager/booking-manager-update/" target="_blank">', '</a>' );
			...
			<div class="welcome-panel-content">
				...
				<div class="welcome-panel-column-container wpbm-help-message ">
					<div class="welcome-panel-column">
						...
						<ul>                          
							...
							<li><div class="welcome-icon"><?php							
									...
									echo '<br/>';
									printf( __( 'Read more about %sshortcode configuration here%s.', 'booking-manager' ), '<a href="http://oplugins.com/plugins/wp-booking-manager/booking-manager-help/">', '</a>' );
								?></div>
							</li>							
					</div>
					<div class="welcome-panel-column">
					...
					<div class="welcome-panel-column welcome-panel-last">
						<h4><?php _e( 'Integartion with', 'booking-manager'); ?> <a href="https://wordpress.org/plugins/booking/" target="_blank">Booking Calendar</a></h4>
						<?php  
				...
				<div class="welcome-panel-footer">
					<div class="welcome-panel-footer-collumn"><?php
								printf( __( 'Still having questions? Contact %sSupport%s.', 'booking-manager'),
									'<a href="http://oplugins.com/plugins/booking-manager/#support" target="_blank">',
									'</a>' );
					...
					printf( __( 'Need even more functionality? Check %s higher versions %s', 'booking-manager'),
							'<a href="http://oplugins.com/plugins/booking-manager/" target="_blank">',
							'</a>' 
						); ?>
					</div>	
