<?php
/*
Plugin Name: Entrepreneur Shortcodes
...
function entrepreneur_shortcodes_load_textdomain() {
    load_plugin_textdomain( THEMO_TEXT_DOMAIN, FALSE, basename( dirname( __FILE__ ) ) . '/lang' );
}

add_action( 'plugins_loaded', 'entrepreneur_shortcodes_load_textdomain' );
...
*/
	function su_add_generator_button( $target = null ) {
		echo '<a href="#TB_inline?width=640&height=600&inlineId=su-generator-wrap" class="thickbox button" title="' . __( 'Insert shortcode', THEMO_TEXT_DOMAIN ) . '" data-page="themo_shortcode_button" data-target="' . $target . '"><img src="' . su_plugin_url() . 'images/admin/media-icon.png"  alt="" /> ' . __( 'Add Shortcode', THEMO_TEXT_DOMAIN ) . '</a>';
	}
			...
			<div id="su-generator">
				<div id="su-generator-shell">
					<div id="su-generator-header">
						<select id="su-generator-select" data-placeholder="<?php _e( 'Select shortcode', THEMO_TEXT_DOMAIN ); ?>" data-no-results-text="<?php _e( 'Shortcode not found', THEMO_TEXT_DOMAIN ); ?>">
						...
						<div id="su-generator-tools">
							<a href="<?php _e( 'http://docs.themovation.com/entrepreneur/#shortcodes', 'themo' ); ?>" target="_blank" title="<?php _e( 'Help', THEMO_TEXT_DOMAIN ); ?>"><?php _e( 'Help', THEMO_TEXT_DOMAIN ); ?></a>
						</div>
					</div>
