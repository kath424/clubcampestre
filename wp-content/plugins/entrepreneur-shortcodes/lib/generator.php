...
require_once( $parse_uri[0] . 'wp-load.php' );
	...
	// Wrapping shortcode
		...
		if(isset($shortcode['textarea']) && $shortcode['textarea'] == 'on'){
			$return .= '<p><label>' . __( 'Content', THEMO_TEXT_DOMAIN ) . '</label><textarea name="su-generator-content" id="su-generator-content" rows="15" cols="65">'. $shortcode['content'] .'</textarea></p>';
		}else{
			$return .= '<p><label>' . __( 'Content', THEMO_TEXT_DOMAIN ) . '</label><input type="text" name="su-generator-content" id="su-generator-content" value="' . $shortcode['content'] . '" /></p>';
		}
	}
	...
	$return .= '<p><a href="#" class="button-primary" id="su-generator-insert">' . __( 'Insert', THEMO_TEXT_DOMAIN ) . '</a></p>';
	//$return .= '<a href="' . su_plugin_url() . '/images/demo/' . $_GET['shortcode'] . '.png" target="_blank" class="button alignright">' . __( 'Demo', THEMO_TEXT_DOMAIN ) . '</a></p>';
	// <a href="#" class="button-primary" id="su-generator-insert-another">' . __( 'Insert & Add Another', THEMO_TEXT_DOMAIN ) . '</a>
